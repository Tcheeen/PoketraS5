...
public class ModelDAO {
    ...
    public void init() throws Exception {
          url ="jdbc:postgresql://localhost:5432/poketra";// databaseNode.getChildNodes().item(1).getTextContent();
        username ="postgres"; //databaseNode.getChildNodes().item(3).getTextContent();
        password = "toky144";//databaseNode.getChildNodes().item(5).getTextContent();   
    }
        ...
        for (int i = 0; i < modelFields.length; i++) {
            ...
            if(coresp.primarykey()){
                ...
                if(modelFields[i].get(this)!=null){
                    ...
                    else if(coresp.nomColonne().equals("")){
    ...
    public Vector getFromBase(Connection c, String query) throws Exception {
